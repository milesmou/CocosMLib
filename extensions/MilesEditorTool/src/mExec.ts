...
export class mExec {
    ...
    static formatProject() {
        ...
        util.mkDirIfNotExists(util.ProjectPath + "/assets/bundle/localization");//资源包目录
        util.mkDirIfNotExists(util.ProjectPath + "/assets/bundle/localization/sc");//资源包目录
        util.mkDirIfNotExists(util.ProjectPath + "/assets/bundle/localization/tc");//资源包目录
        util.mkDirIfNotExists(util.ProjectPath + "/assets/bundle/localization/en");//资源包目录
